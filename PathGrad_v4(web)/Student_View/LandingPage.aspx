...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <!-- Open Settings popup window!! -->
    ...
    <div class="jumbotron">
        <h1 align="center" style=<strong>Snapshot</strong></h1>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <asp:Label ID="Label3" runat="server" Text="Academic Standing"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Text="Good" ></asp:TextBox>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <h2 align="center"><em>Courses in Progress</em></h2>
    ...
    <div class="row">
        <div class="col-md-6">
            <h3>Profile</h3>
            <div class="row">
                <asp:Image ID="Image_Profile" runat="server" margin="100" ImageUrl="~/Images/profile_icon.png" width="125px" style="margin-left: 55px; padding-right: 15px; padding-top: 20px;" Height="125px" ImageAlign="Middle"/>
